    ...
    <div class="span2">
      ...
      <div class="sidebar-nav">
        ...
        <ul class="nav nav-list"> 
          ...
          <li class="active"><a href="typography.html"><i class="icon-font"></i> Typography</a></li>
	...
	<div class="span10">
      <div>
        <ul class="breadcrumb">
          ...
          <li>
            <a href="#">Layout</a> <span class="divider">/</span>
          </li>
      ...
      <div class="row-fluid">
         ...
         <div class="span9">
         	 <!-- Portlet: Typography -->
             <div class="box">
              <h4 class="box-header round-top">Typography inside a box
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales at. Nulla tellus elit, varius non commodo eget, mattis vel eros. In sed ornare nulla. Donec consectetur, velit a pharetra ultricies, diam lorem lacinia risus, ac commodo orci erat eu massa. Sed sit amet nulla ipsum. Donec felis mauris, vulputate sed tempor at, aliquam a ligula. Pellentesque non pulvinar nisi.
         ...
         <div class="span3">
         	 <!-- Portlet: UL -->
             <div class="box">
              <h4 class="box-header round-top">Unordered List
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
            ...
            <div class="box">
              <h4 class="box-header round-top">Ordered List
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
            ...
            <div class="box">
              <h4 class="box-header round-top">Description List
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales at. Nulla tellus elit, varius non commodo eget, mattis vel eros. In sed ornare nulla. Donec consectetur, velit a pharetra ultricies, diam lorem lacinia risus, ac commodo orci erat eu massa. Sed sit amet nulla ipsum. Donec felis mauris, vulputate sed tempor at, aliquam a ligula. Pellentesque non pulvinar nisi.
      ...
      <div class="row-fluid">
         ...
         <div class="span4">
         	 <!-- Portlet: Abbr & Emph -->
             <div class="box">
              <h4 class="box-header round-top">Abbreviations & Emphasis
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
              <div class="box-container-toggle">
                  <div class="box-content">
                    <h2>Abbreviations within text</h2>
                    <p>
                    Nullam quis risus eget urna <strong>mollis ornare</strong> vel eu leo. 
                    Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. 
                    Nullam id dolor id nibh <a href="#">Fusce dapibus</a> vehicula ut id elit.
                    </p>
                    <p>
                     Vivamus sagittis lacus vel <em>augue laoreet rutrum</em> faucibus dolor auctor. 
         ...
         <div class="span4">
         	 <!-- Portlet: Code View -->
             <div class="box">
              <h4 class="box-header round-top">Code view
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
...
&lt;/pre&gt;
         ...
         <div class="span4">
         	 <!-- Portlet: Popovers -->
             <div class="box">
              <h4 class="box-header round-top">Popovers
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
              <div class="box-container-toggle">
                  <div class="box-content">
                    ...
                    <p>Hover over the button to trigger the popover. The popover enables you to display extra information but also be used in a more creative way. 
                    See the popover when hovering the comment button at the top.</p>
