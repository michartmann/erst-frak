...
<head>
  <meta charset="utf-8">
  <title>Admin Simplenso - Empty Template</title>
  ...
  <div class="row-fluid">
    ...
    <div class="span2">
      ...
      <div class="sidebar-nav">
        ...
        <ul class="nav nav-list"> 
          ...
          <li class="active"><a href="portlets.html"><i class="icon-th"></i> Portlets</a></li>
	...
	<div class="span10">
      <div>
        <ul class="breadcrumb">
          <li>
            <a href="#">Level 0</a> <span class="divider">/</span>
          </li>
          <li>
            <a href="#">Level 1</a> <span class="divider">/</span>
          </li>
      ...
      <div class="row-fluid">
         ...
         <div class="span12 column" id="col1"> <!-- class column makes this a sortable column, id=col1 is for the remember position function -->
         	 <!-- Portlet: Box 1 -->
             <div class="box" id="box-0"> <!-- id=box-0 is used for the position storing of the boxes -->
              <h4 class="box-header round-top">Box 1
