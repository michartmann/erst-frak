...
<div class="container-fluid">
  <div class="row-fluid">
	...
	<div class="span10">
      <div>
        <ul class="breadcrumb">
          ...
          <li>
            <a href="grid.html">Layout</a> <span class="divider">/</span>
          </li>
      ...
      <div class="row-fluid">
         ...
         <div class="span6">
             ...
             <div class="box">
              <h4 class="box-header round-top">Standard Table
         ...
         <!-- Portlet Set 1 -->
         <div class="span6">
         	 <!-- Portlet: Striped Table -->
             <div class="box">
              <h4 class="box-header round-top">Striped Table
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
    ...
    <div class="row-fluid">
      	 <!-- Portlet Set 2 -->
         <div class="span12">
         	 <!-- Portlet: Bordered Table -->
             <div class="box">
              <h4 class="box-header round-top">Bordered Table
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
    ...
    <div class="row-fluid">
      	 <!-- Portlet Set 3 -->
         <div class="span6">
         	 <!-- Portlet: Condensed Table -->
             <div class="box">
              <h4 class="box-header round-top">Condensed Table
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
         ...
         <!-- Portlet Set 3 -->
         <div class="span6">
         	 <!-- Portlet: Combined Styles Table -->
             <div class="box">
              <h4 class="box-header round-top">Combined Styles Table
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
 	...
 	<div class="row-fluid">
         ...
         <div class="span12">
         	 <!-- Portlet: Data Table -->
             <div class="box">
              <h4 class="box-header round-top">Data Table
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-info" href="#" rel="tooltip" title="Edit">
